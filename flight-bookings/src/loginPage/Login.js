        ...
        <div className="login-div">
          ...
          <div className="txt_field">
            <input
              ...
              onKeyPress={(e) => (e.key === "Enter" ? validateLogin(e) : null)}
            />
            <span></span>
          ...
          <button className="login-btn" onClick={validateLogin} tabIndex={0}>
            Login Now
          </button>
          <div className="signup_link">
            New to Flight Booking?{" "}
            <span className="create-acc-text">Create an account</span>
          </div>
        </div>
      </div>
    </div>
